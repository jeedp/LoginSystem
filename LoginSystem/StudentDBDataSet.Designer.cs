...
namespace LoginSystem {
    ...
    public partial class StudentDBDataSet : global::System.Data.DataSet {
        ...
        public partial class StudentsDataTable : global::System.Data.TypedTableBase<StudentsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public StudentsRow AddStudentsRow(int StudentID, string FirstName, string LastName, int Age, string Course) {
...
namespace LoginSystem.StudentDBDataSetTableAdapters {
    ...
    public partial class StudentsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Students] ([StudentID], [FirstName], [LastName], [Age], [Cours" +
                "e]) VALUES (@StudentID, @FirstName, @LastName, @Age, @Course);\r\nSELECT StudentID" +
                ", FirstName, LastName, Age, Course FROM Students WHERE (StudentID = @StudentID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Students] SET [StudentID] = @StudentID, [FirstName] = @FirstName, [LastName] = @LastName, [Age] = @Age, [Course] = @Course WHERE (([StudentID] = @Original_StudentID) AND ((@IsNull_FirstName = 1 AND [FirstName] IS NULL) OR ([FirstName] = @Original_FirstName)) AND ((@IsNull_LastName = 1 AND [LastName] IS NULL) OR ([LastName] = @Original_LastName)) AND ((@IsNull_Age = 1 AND [Age] IS NULL) OR ([Age] = @Original_Age)) AND ((@IsNull_Course = 1 AND [Course] IS NULL) OR ([Course] = @Original_Course)));
SELECT StudentID, FirstName, LastName, Age, Course FROM Students WHERE (StudentID = @StudentID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::LoginSystem.Properties.Settings.Default.StudentDBConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT StudentID, FirstName, LastName, Age, Course FROM dbo.Students";
        ...
        public virtual int Delete(int Original_StudentID, string Original_FirstName, string Original_LastName, global::System.Nullable<int> Original_Age, string Original_Course) {
        ...
        public virtual int Insert(int StudentID, string FirstName, string LastName, global::System.Nullable<int> Age, string Course) {
        ...
        public virtual int Update(int StudentID, string FirstName, string LastName, global::System.Nullable<int> Age, string Course, int Original_StudentID, string Original_FirstName, string Original_LastName, global::System.Nullable<int> Original_Age, string Original_Course) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string FirstName, string LastName, global::System.Nullable<int> Age, string Course, int Original_StudentID, string Original_FirstName, string Original_LastName, global::System.Nullable<int> Original_Age, string Original_Course) {
            return this.Update(Original_StudentID, FirstName, LastName, Age, Course, Original_StudentID, Original_FirstName, Original_LastName, Original_Age, Original_Course);
        }
    }
